...
export const options = {
  ...
  thresholds: { phase19_errors: [{ threshold: 'count==0', abortOnFail: true, delayAbortEval: '1s' }], dropped_iterations: [{ threshold: 'count==0', abortOnFail: true, delayAbortEval: '1s' }], http_req_failed: ['rate==0'], ...(mode === 'hotspot' ? { phase19_hot_winners: ['count==1'] } : {}) },
