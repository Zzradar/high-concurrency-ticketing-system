...
Closed 100/500/1000/2000 VU 有效；2000 VU 的 10 分钟观察有效，49530 次业务迭代完成。3000 VU 虽通过发生器资格，正式 SUT 在预热期遇到 2 次 Snapshot 503 并被门禁中止，保留为首次观测不稳定点，不能列入通过档。七场景浏览器 baseline 已完成，正在继续开放模型、旅程和热点基线。前端改动目前只在独立提案副本验证，尚未应用。
