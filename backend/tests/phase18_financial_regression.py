...
env=dict(os.environ,COMPOSE_PROJECT_NAME='phase18-financial',COMPOSE_FILE=str(OUT/'phase18-phase12-regression.json'),TICKETING_BASE_URL='http://127.0.0.1:18186',FAKE_STRIPE_URL='http://127.0.0.1:18187',TICKETING_PAYMENT_PROVIDER='stripe',STRIPE_SECRET_KEY='sk_test_'+secrets.token_hex(24),STRIPE_WEBHOOK_SECRET='whsec_'+secrets.token_hex(24),TICKETING_ADMISSION_HMAC_SECRET=secrets.token_hex(32),STRIPE_PROCESSING_GRACE_SECONDS='600',PYTHONUTF8='1')
